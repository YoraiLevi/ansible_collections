...
Set-Attr $result.ansible_facts "baseboard_product" (Get-WmiObject -class Win32_BaseBoard).product
# Set-Attr $result.ansible_facts "system_product_name" (Get-ItemProperty -Path 'HKLM:\SYSTEM\HardwareConfig\Current\').SystemProductName
